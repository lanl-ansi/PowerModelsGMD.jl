@testset "TEST DATA AC-OPF" begin
    ...
    @testset "B4GIC case" begin
        ...
        @test isapprox(result["objective"], 116384.9314; atol=1e3)
    ...
    @testset "B4GIC-3W case" begin
        ...
        result = _PM.run_ac_opf(case_b4gic3w, ipopt_solver)
        @test result["termination_status"] == _PM.LOCALLY_SOLVED
        @test isapprox(result["objective"], 116384.9314; atol=1e3)
    ...
    @testset "B6GIC-NERC case" begin
        ...
        @test result["termination_status"] == _PM.LOCALLY_SOLVED
        @test isapprox(result["objective"], 977.3899; atol=1e3)
    ...
    @testset "EPRI21 case" begin
        ...
        @test result["termination_status"] == _PM.LOCALLY_SOLVED
        @test isapprox(result["objective"], 401802.4215; atol=1e3)
