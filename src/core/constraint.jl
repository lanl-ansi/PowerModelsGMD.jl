...
function constraint_temperature_state_initial(pm::GenericPowerModel, n::Int, i::Int, fi::Int, c::Int, delta_oil_init, delta_oil_ss, tau, time_elapsed)
    pf = var(pm, n, c, :p, fi) # charge power
    qf = var(pm, n, c, :q, fi) # discharge power 
